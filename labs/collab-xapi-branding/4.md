...
>Tip: you are invited to import one of the [Postman collections for xAPI](https://github.com/CiscoDevNet/postman-xapi) for on-premise and cloud-registered devices (i.e., limited to 'integrator' role supported commands). In the collections, you will discover several extra requests that implement additional commands for branding your device
