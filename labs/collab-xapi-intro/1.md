# Introduction to xAPI for Webex Devices

## Objectives

Throughout this lab, we’ll explore the programmability of [Webex Room and Desk devices](https://www.webex.com/products/devices/index.html).
